...
# AppData (наследник Model): 
Отвечает за хранение данных и логику их обработки. В его полях находятся свойства для хранения карточек каталога, элементов корзины, идентификатора открытого элемента, данных о заказе и ошибок формы.
